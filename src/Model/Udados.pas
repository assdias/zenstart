  ...
  try
    ...
    then
      begin
        ...
        qryParametroSERVIDOR_APP.AsString     :=  '';
        ...
        dados.qryParametroDATABASE_APP.AsString :=  dados.crypt('C', '');
        dados.qryParametroUSUARIO_APP.AsString  :=  dados.crypt('C', '');
        dados.qryParametroSENHA_APP.AsString    :=  dados.crypt('C', '');
...
begin
  ...
  try
    ...
    Except
      ShowMessage('Não foi possivel conectar na base de dados!' + sLineBreak + sLineBreak +
        'Verifique esse arquivo '+ Conexao.Params.Values['Database'] +
        sLineBreak + 'se não encontrar restaure um backup. ' + sLineBreak + 'ou contate o suporte do sistema !');
