object dmPDV: TdmPDV
  ...
  object qryProdutoEmbalagem: TFDQuery
    Connection = Dados.Conexao
    FetchOptions.AssignedValues = [evMode]
    SQL.Strings = (
      
        'SELECT E.FK_PRODUTO, E.DESCRICAO||'#39' C/ '#39'|| E.FATOR_CONV_STR AS U' +
        'NIDADE, E.QTD_ATUAL_CONV_STR ||'#39' '#39'|| E.SIGLA AS QTD_ATUAL, E.FAT' +
        '_CONV'
      'FROM VW_PRODUTO_EMBALAGEM E'
      'WHERE E.FK_PRODUTO = :FK_PRODUTO')
    Left = 496
    Top = 96
    ParamData = <
      item
