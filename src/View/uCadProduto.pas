...
type
  TFrmCadProduto = class(TForm)
    ...
    procedure qryComposicaoAfterOpen(DataSet: TDataSet);
    procedure qryComposicaoAfterClose(DataSet: TDataSet);
  private
    vOperacao: String;
...
procedure TFrmCadProduto.qryComposicaoAfterClose(DataSet: TDataSet);
begin
  DBGridEh2.SumList.Active := False;
end;

procedure TFrmCadProduto.qryComposicaoAfterOpen(DataSet: TDataSet);
begin
